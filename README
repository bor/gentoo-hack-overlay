...
1) Run:
    layman --overlays=http://github.com/bor/gentoo-hack-overlay/raw/master/overlay.xml -L
    layman --overlays=http://github.com/bor/gentoo-hack-overlay/raw/master/overlay.xml -a hack-tools

2) Edit /etc/layman/layman.cfg and add this: (second line)

overlays  : http://www.gentoo.org/proj/en/overlays/layman-global.txt
            http://github.com/bor/gentoo-hack-overlay/tree/master/overlay.xml?raw=true
